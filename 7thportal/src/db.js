...
-- Photo gallery (FRD 8.13) - shipped disabled by default (settings.gallery_enabled),
-- matching the FRD's own recommendation (12.1) to treat this as a Phase 2/3
-- feature rather than initial MVP, pending safeguarding/consent sign-off.
